...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        System.out.println(tubeStationZone1); //for debug purpose
        ...
        londonUGLines[1][8] = "Central Line";
        londonUGLines[1][9] = "HolBorn";
        londonUGLines[1][10] = "Lancaster Gate";
        londonUGLines[1][11] = "Liverpool Street";
        londonUGLines[1][12] = "Marble Arch";
        londonUGLines[1][13] = "Notting Hill Gate";
        londonUGLines[1][14] = "Oxford Circus";
